...
public ResponseEntity<?>update(@PathVariable("id") int id, @RequestBody DtoEducacion dtoEdu)
{
   ...
   {
   return new ResponseEntity(new Mensaje("La experiencia actualozada ya existe"),HttpStatus.BAD_REQUEST);
   }
   if(StringUtils.isBlank(dtoEdu.getNombreEdu()))
   {
   ...
   servEducacion.save(educacion);
   return new ResponseEntity(new Mensaje("La actualizacion de eduycacion esta terminada"),HttpStatus.OK);
}  
}
